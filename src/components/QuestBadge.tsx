...
/* Wider badge mask to fit the goal number + icon */
const BADGE_MASK =
  'M14 0C19.2 0 24 1.32 27.98 3.58L25.1 6.97L2.9 7L0 3.58C3.97 1.32 8.8 0 14 0Z'
...
const ICON_TOP = { x: '-50%', y: '0%', left: '50%', top: -2, width: 8, height: 8 }
...
export default function QuestBadge({ value = 0, goal = 250, pct = 0, transition = false, onTransitionDone }: QuestBadgeProps) {
  ...
  return (
    <div className="quest-badge" data-name="Quest">
      ...
      >
        ...
        {/* Icon + goal side by side */}
        <div className="quest-badge__badge-content">
          <svg className="quest-badge__badge-icon" width="8" height="8" viewBox="0 0 12 12" fill="none" aria-hidden>
            <path
              fillRule="evenodd"
              clipRule="evenodd"
              d={QUEST_ICON_PATH}
          ...
          <p className="quest-badge__badge-text">{goal}</p>
        </div>
      </motion.div>

      {/* Animated icon — starts large in center, slides to badge top */}
      <motion.div
